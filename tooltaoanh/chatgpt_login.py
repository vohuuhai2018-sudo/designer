...
def main():
    ...
    print("Dữ liệu đăng nhập sẽ được lưu tại:", profile_dir)
    ...
    with sync_playwright() as p:
        ...
        print("-> Anh hãy đăng nhập ChatGPT Plus trên cửa sổ trình duyệt vừa hiện lên.")
        ...
        print("-> Khi anh đã gõ tài khoản, đăng nhập thành công và thấy giao diện chat, hãy nhắn lại cho em trên này nhé!")
        print("="*50 + "\n")
